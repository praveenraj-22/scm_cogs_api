...
// app.get('/api-Month-collection-recon/:branch/:date',modules.routes.Month_collectionrecon)
// app.get('/api-Date-collection-recon/:date',modules.routes.Date_collectionrecon)
app.post('/api-depositamount',modules.routes.deposit_amount)
app.get('/api-collectionrecon-data/:branch/:date',modules.routes.collectionrecondata)
app.get('/api-gettotalcollection/:branch/:date',modules.routes.get_totalcollection)
app.get('/api-fingettotalcollection/:date',modules.routes.get_fintotalcollection)
