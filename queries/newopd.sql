...
-- , MONTH(CRE.`CREATEDTIME`)
 ...
 WHERE BRANCH IN ('TBM','ADY','EGM','MGP','NWP','PDY','TVL','TCN','APM','TRI','TNJ','AMN','BMH','WFD','KML','CLR','INR','PNR','YLK','HUB','MCC','MYS','DNR','HMH','MDA','SNR','HIM','SBD','VMH','NEL','GUN','TPT','RAJ','TVM','KOL','KAS','PUN','AHM','IND','CTK','BHU','TPR','AMB','SVR','BSK','RRN','TVT','MPM','RJN','CMB','JGN','HDP','VSH','JWS','APR','ATA','KWA','KTM','GCB','CMR')
GROUP BY
PARENT,
BRANCH
) AS A
...
WHERE BRANCH IN ('BMH', 'WFD', 'KML', 'CLR', 'INR', 'PNR', 'YLK', 'SVR','BSK','RRN','HUB', 'MCC', 'MYS','RJN','JGN')
GROUP BY
BRANCH
) AS A
