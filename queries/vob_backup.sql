...
IF (SERVICE.SERVICE_ID LIKE ('DSAL%'),IF(ITMC.`ITMCGCATEGNAME`='LENS','OPTICALS',SUBSTRING(DEPT.DEPARTMENTNAME,5,LENGTH(DEPT.DEPARTMENTNAME))),ACCHEAD.ACCOUNTHEAD) AS 'unit',
